...
void Lab5::Update(float deltaTimeSeconds)
{
...

	{
		...
		modelMatrix = glm::scale(modelMatrix, glm::vec3(1.f, 0.5f, 0.25f));
		RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
	}

	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(3.5f, 2.5f, 0));
		modelMatrix = glm::rotate(modelMatrix, RADIANS(180.f), glm::vec3(0.5f, 0, 0.3f));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5f, 1.f, 0.75f));
