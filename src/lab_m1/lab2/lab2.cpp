...
void Lab2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, -1,  1), glm::vec3(0.1f, 0.5f, 0.2f), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(-1, 0,  1), glm::vec3(0.3f, 0.3f, 0.5f), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0.6f, 0.1f, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(-1, -1,  0), glm::vec3(1, 1, 0.1f), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(0, -1,  0), glm::vec3(0.7f, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(-1, 0,  0), glm::vec3(0.5f, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 0.2f), glm::vec3(0.2, 0.8, 0.6)),
		};
	...
	{
		vector<VertexFormat> verticesFirstTetrahedron
		{
		...
		vector<unsigned int> indicesFirstTetrahedron =
		{
			0, 1, 2,
			0, 2, 3,
			0, 3, 1,
		...
		CreateMesh("firstTetrahedron", verticesFirstTetrahedron, indicesFirstTetrahedron);
	}

	{
		vector<VertexFormat> verticesSecondTetrahedron
		{
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
		...
		vector<unsigned int> indicesSecondTetrahedron =
		{
			0, 1, 2,
			3, 4, 5,
			6, 7, 8,
		...
		CreateMesh("secondTetrahedron", verticesSecondTetrahedron, indicesSecondTetrahedron);
	}
...
void Lab2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["firstTetrahedron"], shaders["VertexColor"], glm::vec3(1.5f, 0.25f, 0), glm::vec3(0.5f));

	// BONUS
	RenderMesh(meshes["secondTetrahedron"], shaders["VertexColor"], glm::vec3(2.5f, 0.25f, 0), glm::vec3(0.5f));

	// TODO(student): Draw the square
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.25f, 0.25f, 0), glm::vec3(0.5f));
