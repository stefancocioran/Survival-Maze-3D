...
void Lab7::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
	...
	int lightLoc = glGetUniformLocation(shader->program, "light_position");
	...
	int eyeLoc = glGetUniformLocation(shader->program, "eye_position");
	glUniform3f(eyeLoc, eyePosition.x, eyePosition.y, eyePosition.z);
